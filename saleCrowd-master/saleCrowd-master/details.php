...
<head>
	...
	<link href="styles/reviews.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
</head>
<body>
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/sale-crowd.png" alt="Sale Crowd Logo" class="hidden-xs">
                   <img src="images/sale-crowd-mobile.png" alt="Sale Crowd Logo Mobile" class="visible-xs">
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-12"><!-- col-md-12 Begin -->
            ...
            <p>Check out the below reviews for our website.</p>
                ...
                <script>
                    const reviews_product_id = '<?php echo $product_id ;?>';
                    fetch("reviews.php?product_id=" + reviews_product_id).then(response => response.text()).then(data => {
                        ...
                        document.querySelector(".reviews .write_review form").onsubmit = event => {
                            event.preventDefault();
                            fetch("reviews.php?product_id=" + reviews_product_id, {
                                method: 'POST',
